...
public class ReflectorForge
{
    ...
    {
        return Reflector.ForgeIBlockProperties_getLightValue2.exists() ? Reflector.callInt(p_getLightValue_0_, Reflector.ForgeIBlockProperties_getLightValue2, p_getLightValue_1_, p_getLightValue_2_) : p_getLightValue_0_.getLightValue();
    }

    public static MapData getMapData(ItemMap p_getMapData_0_, ItemStack p_getMapData_1_, World p_getMapData_2_)
    {
        return Reflector.ForgeHooksClient.exists() ? ((ItemMap)p_getMapData_1_.getItem()).getMapData(p_getMapData_1_, p_getMapData_2_) : p_getMapData_0_.getMapData(p_getMapData_1_, p_getMapData_2_);
    }
}
