        ...
        else
        {
            ...
            else if (p_getTextureLocation_0_.getResourceDomain().equals("minecraft") && p_getTextureLocation_0_.getResourcePath().startsWith("textures/gui/"))
            {
                ...
                else
                {
                    ...
                    {
                        return getTexturePos(CustomGuiProperties.EnumContainer.CREATIVE, mc.player.getPosition(), iblockaccess, p_getTextureLocation_0_);
                    }
                    else if (guiscreen instanceof GuiInventory)
                    {
                        return getTexturePos(CustomGuiProperties.EnumContainer.INVENTORY, mc.player.getPosition(), iblockaccess, p_getTextureLocation_0_);
                    }
                    else
                    {
